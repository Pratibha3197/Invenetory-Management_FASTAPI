...
# !jupyter notebook --NotebookApp.iopub_data_rate_limit

# # Set the new IOPub data rate limit
# !jupyter notebook --NotebookApp.iopub_data_rate_limit=10000000.0 --NotebookApp.rate_limit_window=5.0
